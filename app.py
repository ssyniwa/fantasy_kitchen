...
RECIPES = {
    ...
    ("エルフの聖なるハーブ","ドラゴンの肉"): {"name": "ドラゴン・タルタルステーキ～聖なるハーブのアクセント～", "trait": "素材の生命力をそのまま味わう、贅沢な一品です。効果: 身体の重さを取り払い、驚異的な跳躍力や俊敏さを授けてくれます。高い崖を登る際や、素早い敵との戦いにおいて真価を発揮するでしょう。", "image": "images/dragon_tea.png"},
    ("ドラゴンの肉", "妖精のハチミツ"): {"name": "竜の丸焼き ～妖精蜜の黄金キャラメリゼ～", "trait": "ドラゴンの肉の塊を、ハチミツの力で究極の逸品に仕上げる王道料理です。効果: ナイフを入れた瞬間、肉汁とハチミツの香りが溢れ出します。ハチミツの甘みが肉の野性味を中和し、口の中でとろけるような食感を生み出します。これを食べた者は、一時的に身体能力が飛躍的に向上し、どんな重い鎧も羽のように軽く感じられるでしょう。", "image": "images/dragon_fairy.png"},
    ("ドラゴンの肉", "魔力のクリスタルシュガー"): {"name": "竜の赤身肉のステーキ ～クリスタルシュガー添え～", "trait": "ドラゴンの肉本来の野性味と、クリスタルシュガーの魔力をダイレクトに味わうための、王道にして至高の調理法です。効果: 口の中で肉汁と共にクリスタルシュガーが弾け、濃厚な旨味と同時に、体中を駆け巡るような魔力の活性化を感じるでしょう。一時的に筋力と魔法耐性が飛躍的に向上し、どんな強敵にも立ち向かえる力が湧いてきます。", "image": "images/dragon_cris.png"},
