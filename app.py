...
RECIPES = {
    ...
    ("エルフの聖なるハーブ","ドラゴンの肉"): {"name": "ドラゴン・タルタルステーキ", "trait": "素材の生命力をそのまま味わう、贅沢な一品です。効果: 身体の重さを取り払い、驚異的な跳躍力や俊敏さを授けてくれます。高い崖を登る際や、素早い敵との戦いにおいて真価を発揮するでしょう。", "image": "images/dragon_tea.png"},
